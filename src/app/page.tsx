...
const Commitment = dynamic(() => import('@/app/components/Commitment'), { ssr: false });
...
export default function HomePage() {
  ...
  const solutions = [
    {
      ...
      icon: (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M24 12L28 20H32L25 24L29 32L24 27L19 32L23 24L16 20H20L24 12Z" fill="#022C22"/>
        </svg>
      )
    },
    {
      title: "Impacto na Comunidade",
      description: "Mais do que construir, cultivamos raízes: o pé de manga no coração da Moita simboliza nosso compromisso em gerar vida, compartilhar frutos e fortalecer a comunidade local.",
      image: "/images/origem/origem-2.jpg",
      icon: (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 8C0 3.58172 3.58172 0 8 0H40C44.4183 0 48 3.58172 48 8V40C48 44.4183 44.4183 48 40 48H8C3.58172 48 0 44.4183 0 40V8Z" fill="white"/>
          <path d="M32 32H16V28H32V32ZM36 24H12V20H36V24ZM40 16H8V12H40V16Z" fill="#022C22"/>
        </svg>
      )
    },
    {
      title: "Inovação & Pesquisa",
      description: "Do ferro que sustenta nossas estruturas aos tijolos ecológicos que moldam os espaços, cada solução nasce da busca por equilíbrio entre inovação e sustentabilidade. Transformamos técnicas construtivas em ambientes que oferecem conforto, estética e eficiência energética.",
      image: "/images/origem/origem-3.jpg",
      icon: (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 8C0 3.58172 3.58172 0 8 0H40C44.4183 0 48 3.58172 48 8V40C48 44.4183 44.4183 48 40 48H8C3.58172 48 0 44.4183 0 40V8Z" fill="white"/>
          <path d="M24 12L30 22H18L24 12ZM24 28C27.3137 28 30 25.3137 30 22C30 18.6863 27.3137 16 24 16C20.6863 16 18 18.6863 18 22C18 25.3137 20.6863 28 24 28Z" fill="#022C22"/>
        </svg>
      )
    },
    {
      title: "Responsabilidade Ambiental",
      description: "Entre o canto da seriema e o voo do tucano, reafirmamos nossa missão: proteger a biodiversidade do Cerrado e garantir que a Moita seja um espaço de convivência harmônica com a natureza.",
      image: "/images/origem/origem-4.jpg",
      icon: (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 8C0 3.58172 3.58172 0 8 0H40C44.4183 0 48 3.58172 48 8V40C48 44.4183 44.4183 48 40 48H8C3.58172 48 0 44.4183 0 40V8Z" fill="white"/>
          <path d="M24 12C15.1634 12 8 19.1634 8 28C8 36.8366 15.1634 44 24 44C32.8366 44 40 36.8366 40 28C40 19.1634 32.8366 12 24 12ZM24 40C17.3726 40 12 34.6274 12 28C12 21.3726 17.3726 16 24 16C30.6274 16 36 21.3726 36 28C36 34.6274 30.6274 40 24 40Z" fill="#022C22"/>
        </svg>
      )
    }
  ]
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <div className="relative pt-24 pb-32 sm:pb-40 lg:pt-40 lg:pb-64 bg-teal-900">
        <div className="absolute inset-0 overflow-hidden">
          <Image
            src="/fauna-assets/headers/bg-waves.png"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <motion.h1 
              className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight text-white mb-6"
            ...
            >
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex py-4 px-8 items-center justify-center text-lg font-medium text-teal-900 bg-lime-500 hover:bg-lime-400 rounded-full transition-colors duration-300 transform hover:scale-105"
              >
                Reservar Agora
              </a>
            </motion.div>
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-10">
              <div className="text-center">
                <h3 className="text-3xl lg:text-4xl font-medium mb-3 text-teal-800">3.040 m²</h3>
                <p className="text-gray-700">Natureza preservada às margens do Capivari</p>
              </div>
            </div>
            <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-10">
              <div className="text-center">
                <h3 className="text-3xl lg:text-4xl font-medium mb-3 text-teal-800">4 unidades</h3>
                <p className="text-gray-700">Chalés e cabanas exclusivas para descanso</p>
              </div>
            </div>
            <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-10">
              <div className="text-center">
                <h3 className="text-3xl lg:text-4xl font-medium mb-3 text-teal-800">80%+ área permeável</h3>
                <p className="text-gray-700">Conexão real com o Cerrado vivo</p>
              </div>
            </div>
            <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-10">
              <div className="text-center">
                <h3 className="text-3xl lg:text-4xl font-medium mb-3 text-teal-800">100+ hóspedes</h3>
                <p className="text-gray-700">Experiências autênticas já compartilhadas</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Solutions Section */}
      <section id="nossos-pilares" className="p-4 bg-white">
        <div className="pt-16 pb-24 px-5 xs:px-8 xl:px-12 bg-lime-500 rounded-3xl">
          <div className="container mx-auto px-4">
            <div className="flex mb-4 items-center">
              ...
              <span className="inline-block ml-2 text-sm font-medium">Nossos Pilares</span>
            </div>
            <div className="border-t border-teal-900 border-opacity-25 pt-14">
              <h1 className="font-heading text-4xl sm:text-6xl mb-24">O que nos move e inspira</h1>
              <div className="flex flex-wrap -mx-4">
                  ...
                  >
                    <div>
                      ...
                      <div className="mt-6">
                        ...
                        <Link href="#" className="inline-block text-lg font-medium hover:text-teal-700 transition-colors">
                          Read more
                        </Link>
                      </div>
                    </div>
      ...
      <section id="chales" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center -mx-4">
            {/* Left Column - Text Content */}
            <div className="w-full md:w-1/2 px-4 mb-10 md:mb-0">
              <div className="max-w-lg mx-auto md:mx-0">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium text-teal-900 mb-6">
                  Entre árvores e silêncios, devolvemos o essencial: tempo, presença e vida plena.
                </h2>
                <p className="text-lg text-gray-700 mb-8">
                  Descubra um refúgio onde a natureza e o conforto se encontram, criando experiências que renovam corpo e alma.
                </p>
                <a href="#reservar" className="bg-teal-900 hover:bg-teal-800 text-white font-medium py-3 px-8 rounded-full transition-colors inline-block">
                  Reservar Agora
                </a>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2 px-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="relative aspect-square rounded-2xl overflow-hidden">
                  <Image
                    src="/images/origem/origem-1.jpg"
                ...
                <div className="relative aspect-square rounded-2xl overflow-hidden">
                  <Image
                    src="/images/origem/origem-2.jpg"
                    alt="Momento de paz"
                    fill
                    className="object-cover"
                  />
                ...
                <div className="relative aspect-square rounded-2xl overflow-hidden">
                  <Image
                    src="/images/origem/origem-3.jpg"
                ...
                <div className="relative aspect-square rounded-2xl overflow-hidden">
                  <Image
                    src="/images/origem/origem-4.jpg"
      ...
      */}
      ...
      {/* Footer */}
      <footer className="relative py-12 lg:py-16" style={{ backgroundColor: '#f3efe8' }}>
        <Image
        ...
        <div className="container px-4 mx-auto relative">
          <div className="flex flex-col lg:flex-row justify-between mb-12">
                ...
                <ul className="mt-4 space-y-2">
                  <li>
                    <a 
                      ...
                      className="text-base text-gray-600 hover:text-lime-600 transition-colors"
                    >
                      Início
                    </a>
                  </li>
            ...
            <div className="mt-8 lg:mt-0">
              ...
              <address className="mt-4 not-italic text-base text-gray-600">
                <p>Rio Capivari, Abadiânia-GO</p>
                <a href="mailto:contato@moitanativa.com.br" className="block mt-2 hover:text-lime-600 transition-colors">contato@moitanativa.com.br</a>
              </address>
            </div>
          </div>

          <div className="border-t border-gray-200 pt-8 mt-12">
            <p className="text-base text-gray-500 text-center">&copy; 2025 A Moita. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
